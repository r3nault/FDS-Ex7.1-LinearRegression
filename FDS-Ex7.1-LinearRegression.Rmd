...
The least squares regression supports metro having a negative relationship with energy. metro is a significant variable with respect to energy, however the R^2^ and adjusted R^2^ are both quite low.
